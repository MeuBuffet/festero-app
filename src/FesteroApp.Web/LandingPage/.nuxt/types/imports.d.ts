...
declare global {
  ...
  const useBreadcrumb: typeof import('bootstrap-vue-next')['useBreadcrumb']
  const useColorMode: typeof import('bootstrap-vue-next')['useColorMode']
  ...
  const useModal: typeof import('bootstrap-vue-next')['useModal']
  const useModalController: typeof import('bootstrap-vue-next')['useModalController']
  ...
  const useScrollspy: typeof import('bootstrap-vue-next')['useScrollspy']
  ...
  const useToast: typeof import('bootstrap-vue-next')['useToast']
...
declare module 'vue' {
  interface ComponentCustomProperties {
    ...
    readonly useBreadcrumb: UnwrapRef<typeof import('bootstrap-vue-next')['useBreadcrumb']>
    readonly useColorMode: UnwrapRef<typeof import('bootstrap-vue-next')['useColorMode']>
    ...
    readonly useModal: UnwrapRef<typeof import('bootstrap-vue-next')['useModal']>
    readonly useModalController: UnwrapRef<typeof import('bootstrap-vue-next')['useModalController']>
    ...
    readonly useScrollspy: UnwrapRef<typeof import('bootstrap-vue-next')['useScrollspy']>
    ...
    readonly useToast: UnwrapRef<typeof import('bootstrap-vue-next')['useToast']>
